...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Login | Mansou Imóveis</title>
				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="assets/media/logos/logo_mansou.png" class="max-h-120px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>Login</h3>
								<div class="text-muted font-weight-bold">Entre com as suas informações para logar na sua conta:</div>
							</div>
							<form class="form" id="kt_login_signin_form">
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Email" name="" autocomplete="off" />
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password" placeholder="senha" name="" />
								</div>
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									<div class="checkbox-inline">
										<label class=" m-0 text-muted">
										<input type="checkbox" name="remember"  />
										<span></span>Continuar conectado</label>
									</div>
						...
						<div class="login-forgot">
							<div class="mb-20">
								...
								<div class="text-muted font-weight-bold">Entre com seu email para criar sua nova senha</div>
							</div>
